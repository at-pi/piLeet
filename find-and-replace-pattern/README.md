<h2>890. Find and Replace Pattern</h2><h3>Medium</h3><hr><div><p>You have a list of&nbsp;<code>words</code> and a <code>pattern</code>, and you want to know which words in <code>words</code> matches the pattern.</p>
