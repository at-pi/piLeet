<h2>1497. Check If Array Pairs Are Divisible by k</h2><h3>Medium</h3><hr><div><p>Given an array of integers <code>arr</code> of even length <code>n</code> and an integer <code>k</code>.</p>
